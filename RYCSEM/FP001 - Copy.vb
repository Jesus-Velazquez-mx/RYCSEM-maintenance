Public Class FP001
    Dim rPrv As DS_FP001.proveedoresRow
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Habilita(False)
        Me.sdaStatus.Fill(Me.DS_FP001.status)
        Me.refrescar()
    End Sub
    Private Sub MToolBar1_ButtonClick(indice As Integer) Handles MToolBar1.ButtonClick
        Select Case indice
            ...
            Case 10 'deshacer
                Me.deshacer()
            Case 12 'imprimir
                Help.imprimeReporte("R_FP001", Me.DS_FP001, Me.Name)
        End Select
    End Sub
    ...
    Private Sub refrescar()
        Me.DS_FP001.proveedores.Clear()
        If Me.sdaProveedores.Fill(Me.DS_FP001.proveedores) > 0 Then
    ...
    Private Function validar() As Boolean
        ...
        If Me.txtNombre.Text.Trim = "" Then
            ...
            Return False
        End If
        If Me.txtApPaterno.Text.Trim = "" Then
            MsgBox("Ingrese apellido paterno", MsgBoxStyle.Information)
            Return False
        End If
        If Me.txtApMaterno.Text.Trim = "" Then
    ...
    Private Sub guardar()
        Try
            ...
            If Me.MToolBar1.Band = "N" Then Me.rPrv.cod_prv = Me.obtieneFolio()
            Me.BindingContext(Me.dvProveedores).EndCurrentEdit()
            Me.sdaProveedores.Update(Me.DS_FP001.proveedores)
    ...
    Private Sub nuevo()
        Me.Habilita(True)
        rPrv = Me.DS_FP001.proveedores.NewRow
        ...
        Me.DS_FP001.proveedores.AddproveedoresRow(rPrv)
