Public Class FC001
    ...
    Dim Band As String = ""
    Dim Trans As String = "09" 'clientes 
    ...
    Private Function validar() As Boolean
        ...
        '    Return False
        'End If
        If Me.txtRazonSocial.Text.Trim = "" And Me.txtNombre.Text.Trim = "" Then
            MsgBox("Ingrese un nombre o razón social", MsgBoxStyle.Information)
            Me.txtRazonSocial.Focus()
            Return False
        End If
        If Me.txtNombre.Text.Trim <> "" And Me.txtApPat.Text.Trim = "" Then
    ...
    Private Sub posicion(Optional ByVal cod_cte As String = "")
        Dim pos As Integer
        If Me.DS_FC001.clientes.Count <= 0 Then Exit Sub
